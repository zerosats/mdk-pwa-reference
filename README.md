...
Encrypted messaging PWA built with Vue 3 and TypeScript. Uses MLS encryption over Nostr for relay-blind messaging — relays see encrypted blobs, never message content. AI agents can participate in chats and make Bitcoin payments autonomously via Arkade wallet infrastructure.
